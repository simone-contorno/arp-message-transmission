...
int main(int argc, char * argv[]){
    ...
    if (size > 60000) { // 8 million
        printf("The message dimension is too large, please insert a value less than 60.000!\n");
        fflush(stdout);
        exit(-1);
    }
    ...
    clock_t end = clock();
    double expired_time = (double)(end - begin) / CLOCKS_PER_SEC;
